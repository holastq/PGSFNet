...
def load_resume_state(opt):
    ...
    if opt['auto_resume']:
        print("begin to autoly resume the state")
...
def train_pipeline(root_path):
    ...
    train_val_dataloader = create_train_val_dataloader(opt, logger)
    train_loader, train_sampler, val_loaders, total_epochs, total_iters = train_val_dataloader
